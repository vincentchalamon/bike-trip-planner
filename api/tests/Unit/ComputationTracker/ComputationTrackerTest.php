...
final class ComputationTrackerTest extends TestCase
{
    ...
    #[Test]
    public function isAllCompleteWhenAllDone(): void
    {
        $this->tracker->initializeComputations('trip-1', [
            ComputationName::ROUTE,
            ComputationName::STAGES,
        ...
        $this->assertTrue($this->tracker->isAllComplete('trip-1'));
    }

    #[Test]
    public function isAllCompleteWhenAllFailed(): void
    {
        $this->tracker->initializeComputations('trip-1', [
            ComputationName::ROUTE,
            ComputationName::STAGES,
    ...
    #[Test]
    public function isAllCompleteWithMixedDoneAndFailed(): void
    {
        $this->tracker->initializeComputations('trip-1', [
            ComputationName::ROUTE,
            ComputationName::STAGES,
    ...
    #[Test]
    public function isAllCompleteReturnsFalseWhenPending(): void
    {
        $this->tracker->initializeComputations('trip-1', [
            ComputationName::ROUTE,
            ComputationName::STAGES,
        ...
        $this->assertFalse($this->tracker->isAllComplete('trip-1'));
    }

    #[Test]
    public function isAllCompleteReturnsFalseWhenRunning(): void
    {
        $this->tracker->initializeComputations('trip-1', [
            ComputationName::ROUTE,
        ]);
    ...
    #[Test]
    public function isAllCompleteReturnsFalseForUnknownTrip(): void
    {
        $this->assertFalse($this->tracker->isAllComplete('unknown-trip'));
    }
