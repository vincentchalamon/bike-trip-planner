...
export const fr = {
  ...
  trip: {
    ...
    banners: {
      ...
      offline: 'Lecture seule — Internet indisponible.',
      apiUnavailable: 'Lecture seule — service indisponible.',
    ...
    // Libellés des catégories POI de ravitaillement (valeur OSM brute sinon, #1196).
    poiCategory: {
      bakery: 'Boulangerie',
      butcher: 'Boucherie',
    ...
    blocks: {
      ...
      accommodationSourceManual: 'Manuel',
      accommodationAddManual: 'Ajouter un hébergement',
      accommodationManualNamePlaceholder: 'Titre',
      accommodationManualAddressPlaceholder: 'Adresse (rue, ville)',
      accommodationManualPricePlaceholder: 'Prix total (€)',
      accommodationManualUrlPlaceholder: 'Lien (optionnel)',
      accommodationManualSave: 'Ajouter',
      accommodationManualCancel: 'Annuler',
