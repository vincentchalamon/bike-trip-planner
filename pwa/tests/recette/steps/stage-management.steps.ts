...
When(
  "je clique sur le titre du voyage",
  async ({ $test }) => {
    $test.fixme();
  },
);
...
When(
  "je rétablis l'action avec Ctrl+Y",
  async ({ $test }) => {
    $test.fixme();
  },
);
...
When(
  "I split stage {int} at mid-route",
  async ({ $test }, _stage: number) => {
    $test.fixme();
  },
);
...
Then(
  "je vois la durée totale du voyage en jours",
  async () => {},
);
...
Then(
  "l'étape est revenue à son état précédent",
  async () => {},
);

Then(
  "l'étape est à nouveau modifiée",
  async () => {},
);
...
Then(
  "I only see {int} stage cards",
  async () => {},
);

Then(
  "I see {int} stage cards",
  async () => {},
);
...
Then(
  "I see the total trip duration in days",
  async () => {},
);
...
Then(
  "the stage has reverted to its previous state",
  async () => {},
);

Then(
  "the stage is modified again",
  async () => {},
);
