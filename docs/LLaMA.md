...
> **Withdrawn (2026-08-11) — AI support has been removed from the product. See [ADR-052](adr/adr-052-remove-ai-support.md).** This record is kept for historical context only.
