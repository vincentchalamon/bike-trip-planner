...
| Design | [#1214](https://github.com/vincentchalamon/bike-trip-planner/issues/1214) | lot de divergences maquettes (copies, palette, icônes) — recette #1181 | Task | M | ✅ A+C mergés ([#1216](https://github.com/vincentchalamon/bike-trip-planner/pull/1216)) — B (palette) à arbitrer |
